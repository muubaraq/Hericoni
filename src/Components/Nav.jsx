...
const Nav = () => {
   ...
   <ul className="text-center text-xl p-20 font-primaryFont font-bold">
        <AnchorLink AnchorLink href="#Video"> <li className="my-9 hover:text-oxBlood transition">Videos</li></AnchorLink> 
         ...
         <AnchorLink href="#Follow"><li className="my-9  transition hover:text-oxBlood">Follow + Join</li></AnchorLink>
     ...
     <div className=" items-center justify-end lg:block hidden">
       <div className="flex-10 ">
          <ul className="flex gap-5 md:text-[16px] text-[9px]  items-center font-primaryFont font-bold">
             ...
             <AnchorLink  href="#Digital"><li className="transition hover:text-oxBlood flex items-center gap-2">Digital Download <span className="inline-block w-7 h-[2px] bg-[#fff]"></span></li></AnchorLink>
             ...
             <AnchorLink href="#Follow"><li className="transition hover:text-oxBlood ">Follow + Join</li></AnchorLink>
          </ul>
       </div>
     </div>
     <div>
