     ...
     <div className="grid md:grid-cols-2 gap-5 items-center justify">
        <div className="border border-[white] rounded-s-2xl rounded-e-2xl relative">
            <div className=" text-[white] p-2  text-center md:hidden block absolute top-28 right-2 drop-shadow-[4px]">
                ...
                <small className="font-bold text-xs me-1">featuring Sheliroy<br/>  (dropping on 1st March 2024) by</small>
                <a href="https://distrokid.com/hyperfollow/hericoni/aje-ale-feat-sheliroy-2" target="_blank" rel="noreferrer" className="hover:text-oxBlood text-[9px] block bg-[black] rounded px-1 py-1 w-20 mx-auto mt-2" >clicking here</a>
            </div>
        ...
        <div className=" text-[white] p-2 md:text-start text-center md:block hidden">
            ...
            <small className="font-bold text-sm">featuring Sheliroy (dropping on 1st March 2024) by </small>
