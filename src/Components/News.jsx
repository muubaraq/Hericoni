...
const News = () => {
  ...
  return (
    <>
     <section className="md:px-6 py-4 mt-[15px] border border-oxBlood font-primaryFont" id="News">
     <div className="grid md:grid-cols-2 gap-5 items-center ">
        ...
        <div className=" text-[white] p-2 md:text-start text-center md:block hidden justify-self-center">
            <small className="font-bold text-base">Check out my new single </small>
            <p className="text-7xl font-bold my-3" style={{ color: color }}>Aje ale</p>
